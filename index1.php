...
<div class="wrapper row1">
  <header id="header" class="full_width clear">
    <div id="hgroup">
	 <span><a href="index1.php"><img src="images\logo150x150.png"></a> </span>
         <span><h1><a href="index1.php">Share4U</a></h1></span>
         <span><h2>Share for wourld</h2></span>
	...
	<li><span class="login"></span>Login</li>
      ...
      <div class="two_third first">
        ...
        <div class="two_third first">
          <article class="push30 clear">
            <div class="imgl boxholder"><a href="#"><img src="images/demo/100x100.gif" alt=""></a></div>
        ...
        <div class="one_third">
          <div class="boxholder push30"><a href="#"><img src="images/demo/1200x400.gif" alt=""></a></div>
          <div class="boxholder push30"><a href="#"><img src="images/demo/1200x400.gif" alt=""></a></div>
          <div class="boxholder push30"><a href="#"><img src="images/demo/1200x400.gif" alt=""></a></div>
          <div class="boxholder"><a href="#"><img src="images/demo/1200x400.gif" alt=""></a></div>
        </div>
        <!-- #### -->
        <div class="clear"></div>
      </div>
      ...
      <div class="one_third">
        ...
        <div class="clear push20">
          <article class="one_half first">
            ...
            <a href="#">Read More &raquo;</a></article>
          <div class="one_half">
            <h2 class="font-medium">Headline Text</h2>
            <ul class="list none">
              <li><a href="#">Etiam id sapien vitae.</a></li>
              <li><a href="#">Maecenas cursus lectus.</a></li>
              <li><a href="#">Etiam fermentum nulla.</a></li>
              <li><a href="#">Sed aliquet semper eros.</a></li>
              <li><a href="#">Nullam tempus dictum.</a></li>
